  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex flex-col items-center flex-grow pt-24 pb-12 px-4">
        ...
        <div className="bg-card p-6 sm:p-8 rounded-lg shadow-lg max-w-3xl w-full text-left space-y-4 text-muted-foreground">
          ...
          <h2 className="text-2xl font-semibold text-secondary-foreground pt-2">Información que Recopilamos</h2>
          ...
          <h2 className="text-2xl font-semibold text-secondary-foreground pt-2">Cómo Usamos tu Información</h2>
          ...
          <h2 className="text-2xl font-semibold text-secondary-foreground pt-2">Compartir Información</h2>
          <p>Podemos compartir tu información con conductores para facilitar los viajes, con proveedores de servicios que nos ayudan a operar, y según lo exija la ley. No vendemos tu información personal a terceros.</p>
           <h2 className="text-2xl font-semibold text-secondary-foreground pt-2">Tus Derechos</h2>
